...
enum SettingsCatalog {
    ...
    static let tabs: [SettingsTab] = [
        ...
        SettingsTab(
            id: SettingsTabID.switcher, title: String(localized: "Behaviour"), icon: "rectangle.stack.fill",
    ...
    static let searchItems: [SettingsSearchItem] = [
        ...
        // Switcher · Display
        item(SearchID.displayMonitor, .switcher, SettingsAnchor.display, String(localized: "Behaviour"), String(localized: "Display"),
             String(localized: "Show switcher on"), ["display", "monitor", "screen", "multi monitor", "cursor", "main display", "active space"]),
        // Switcher · Contents
        item(SearchID.showMinimized, .switcher, SettingsAnchor.contents, String(localized: "Behaviour"), String(localized: "Contents"),
             String(localized: "Show minimized windows"), ["minimized", "minimize"]),
        item(SearchID.showHidden, .switcher, SettingsAnchor.contents, String(localized: "Behaviour"), String(localized: "Contents"),
             String(localized: "Show hidden apps"), ["hidden", "hide"]),
        item(SearchID.showWindowless, .switcher, SettingsAnchor.contents, String(localized: "Behaviour"), String(localized: "Contents"),
             String(localized: "Show apps without windows"), ["windowless", "no windows", "background apps"]),
        item(SearchID.applicationsOnly, .switcher, SettingsAnchor.contents, String(localized: "Behaviour"), String(localized: "Contents"),
             String(localized: "Applications only"),
             ["applications only", "apps only", "one per app", "per app", "command tab", "classic", "group windows"]),
        item(SearchID.showBadges, .switcher, SettingsAnchor.contents, String(localized: "Behaviour"), String(localized: "Contents"),
             String(localized: "Show unread badges"), ["badge", "unread", "dock badge", "count"]),
        item(SearchID.currentSpaceOnly, .switcher, SettingsAnchor.contents, String(localized: "Behaviour"), String(localized: "Contents"),
             String(localized: "Only current Space"), ["space", "current space", "desktop", "filter"]),
        item(SearchID.sortOrder, .switcher, SettingsAnchor.contents, String(localized: "Behaviour"), String(localized: "Contents"),
             String(localized: "Sort order"), ["sort", "order", "mru", "most recent", "alphabetical", "launch order"]),
        item(SearchID.showRecentlyClosed, .switcher, SettingsAnchor.contents, String(localized: "Behaviour"), String(localized: "Contents"),
             String(localized: "Show recently closed apps"), ["recently closed", "reopen", "recent"]),
        item(SearchID.recentlyClosedLimit, .switcher, SettingsAnchor.contents, String(localized: "Behaviour"), String(localized: "Contents"),
             String(localized: "Recently closed to show"), ["recently closed", "limit", "count"]),
        // Switcher · Tabs
        item(SearchID.tabDrill, .switcher, SettingsAnchor.tabs, String(localized: "Behaviour"), String(localized: "Tabs"),
             String(localized: "Peek tabs with \\"), ["tabs", "tab", "drill", "peek", "backslash", "finder tabs", "browser tabs", "safari", "chrome"]),
        item(SearchID.expandTabs, .switcher, SettingsAnchor.tabs, String(localized: "Behaviour"), String(localized: "Tabs"),
             String(localized: "Show tabs as separate entries"), ["tabs", "tab", "expand", "separate", "rows", "per tab", "finder", "terminal", "native tabs"]),
        item(SearchID.expandBrowserTabs, .switcher, SettingsAnchor.tabs, String(localized: "Behaviour"), String(localized: "Tabs"),
        ...
        item(SearchID.tabPermissions, .switcher, SettingsAnchor.tabs, String(localized: "Behaviour"), String(localized: "Tabs"),
             String(localized: "Browser tab access"), ["tabs", "apple events", "automation", "permission", "browser", "consent"]),
        // Switcher · Search
        item(SearchID.letterHints, .switcher, SettingsAnchor.search, String(localized: "Behaviour"), String(localized: "Search"),
             String(localized: "Letter hints"), ["letter hints", "jump", "vim"]),
        item(SearchID.letterChainTimeout, .switcher, SettingsAnchor.search, String(localized: "Behaviour"), String(localized: "Search"),
             String(localized: "Letter chain timeout"), ["letter", "chain", "timeout", "reset", "jump", "delay", "prefix", "sequence", "expire"]),
        item(SearchID.fuzzy, .switcher, SettingsAnchor.search, String(localized: "Behaviour"), String(localized: "Search"),
             String(localized: "Type-to-filter search"), ["search", "filter", "fuzzy", "type"]),
        item(SearchID.launcher, .switcher, SettingsAnchor.search, String(localized: "Behaviour"), String(localized: "Search"),
             String(localized: "Launch apps from search"), ["launcher", "launch", "open app"]),
        item(SearchID.searchMode, .switcher, SettingsAnchor.search, String(localized: "Behaviour"), String(localized: "Search"),
             String(localized: "When searching"), ["search mode", "hold", "stay open", "dismiss"]),
        // Switcher · Navigation
        item(SearchID.shiftTapBack, .switcher, SettingsAnchor.navigation, String(localized: "Behaviour"), String(localized: "Navigation"),
             String(localized: "Tap Shift to step backwards"), ["shift", "backwards", "back", "reverse", "tap shift", "cmd shift tab", "windows"]),
        item(SearchID.scroll, .switcher, SettingsAnchor.navigation, String(localized: "Behaviour"), String(localized: "Navigation"),
             String(localized: "Switch with mouse scroll"), ["scroll", "wheel", "mouse"]),
        item(SearchID.scrollReverse, .switcher, SettingsAnchor.navigation, String(localized: "Behaviour"), String(localized: "Navigation"),
             String(localized: "Reverse scroll direction"), ["scroll", "reverse", "invert"]),
        item(SearchID.clickDismiss, .switcher, SettingsAnchor.navigation, String(localized: "Behaviour"), String(localized: "Navigation"),
             String(localized: "Click outside to dismiss"), ["click", "outside", "dismiss", "cancel", "spotlight"]),
        item(SearchID.vimNavigation, .switcher, SettingsAnchor.navigation, String(localized: "Behaviour"), String(localized: "Navigation"),
             String(localized: "Vim keys (h j k l)"), ["vim", "hjkl", "h j k l", "keyboard", "arrows", "navigation"]),
        // Switcher · Actions
        item(SearchID.hoverActions, .switcher, SettingsAnchor.actions, String(localized: "Behaviour"), String(localized: "Hover actions"),
